...
(cl:defmethod cl:initialize-instance :after ((m <floatStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'floatStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_car-msg:<floatStamped> is deprecated: use my_car-msg:floatStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <floatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_car-msg:header-val is deprecated.  Use my_car-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <floatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_car-msg:data-val is deprecated.  Use my_car-msg:data instead.")
  (data m))
